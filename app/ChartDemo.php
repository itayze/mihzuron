...
$userName2='ortp';//$_POST['userName'];
     ...
     function getMonthRev($mo,$conn){
         ...
         $sum=0;
      $sql="SELECT * from posts WHERE userName='".$userName2."'AND MONTH(date)='".$mo."'";
    //   '".$userName."'AND MONTH(date)='".$mo."' OR paidUser='".$userName."'AND MONTH(date)='".$mo."'"; 
