                                        ...
                                        <div class="row">
                                            <div class="contact-cat col-sm-4 col-lg-3">
                                                ...
                                                <div class="roles-menu">
                                                    <ul>
                                                        <li class="active"><a href="feed.php">הכל</a></li>
                                            ...
                                            <div class="contacts-list col-sm-8 col-lg-9">
                                                <ul class="contact-list" id="feed">
                                                        ...
                                                        $sql="SELECT * from posts WHERE paid=0 AND isDeleted='0' ORDER BY id DESC LIMIT 5";
                                                                   ...
                                                                   if($row['userName']!=$userName)
                                                                     ...
                                                                     <span class="contact-date">
                                                                           ...
                                                                           <input type="hidden" name="postId" value='.$row['id'].'>
                                                                            <button  style="position: relative;float:left; bottom:30px;display:inline;" class="btn btn-primary" type="submit" name="pay" id="pay">שריין
