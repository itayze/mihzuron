    ...
    $sql="SELECT * from notifications where owner='".$userName."' ORDER BY id DESC LIMIT 10";
     $result=$conn-> query($sql);
                                        ...
                                        <div class="media" style="line-height:2;">
											...
											<br>
												...
												$useragent=$_SERVER['HTTP_USER_AGENT'];
                                                                        ...
                                                                        { 
                                                                            echo '
                                                                        	היכנס עכשיו ל<a href="myPost.html"  style="padding:0; display:inline;">
												מיחזורים שלי
												</a> 
												';
                                                                        }
										...
										$useragent=$_SERVER['HTTP_USER_AGENT'];
                                                                        ...
                                                                        { 
                                                                            echo '
                                                                        	היכנס עכשיו ל<a href="paidRec.html"  style="padding:0; display:inline;">
												מיחזורים שקניתי
												</a> 
												';
                                                                        }
...
$useragent=$_SERVER['HTTP_USER_AGENT'];
                                                                        ...
                                                                        { 
                                                                            echo '
                                                                        	היכנס עכשיו ל<a href="myPosts.html"  style="padding:0; display:inline;">
												מיחזורים שלי
												</a> 
												';
                                                                        }
